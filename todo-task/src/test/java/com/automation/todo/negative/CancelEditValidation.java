...
public class CancelEditValidation extends Tests {
	...
	public void preTestExecution() {
		...
		log = (Logger) LogManager.getLogger(CancelEditValidation.class);
	...
	@Test
	public void CancelEditValidationTest() throws Exception {
		...
		/*
		 * Step3 : Double click on tasks
		 * 
		 */

		log.info("Step2 : Double click on tasks");

		todoPage.doubleClickOnTask(className, prop.getGenericProp("LongerText"));

		/*
		 * Step3 : Cancel Edit by sending no values in input field
		 * 
		 */
		log.info("Step3 : Cancel Edit by sending no values in input field");
		todoPage.updateTaskFunctionaity(className, "");

		/*
		 * Step4 : Validate task is not getting updated after cancel edit.
		 * 
		 */

		log.info("Step4 : Validate task is not getting updated after cancel edit.");
