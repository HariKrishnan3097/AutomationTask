...
public class HtmlInjectionValidation extends Tests {
	...
	public void preTestExecution() {
		...
		log = (Logger) LogManager.getLogger(HtmlInjectionValidation.class);
	...
	@Test
	public void HtmlInjectionValidationTest() throws Exception {
		...
		todoPage.addTaskFunctionality(prop.getGenericProp("HtmlInput"), className);
		...
		Assert.assertEquals(todoPage.validateTasksRemovedFromList(prop.getGenericProp("HtmlInput")), false,"Input field allows HTML tags");
